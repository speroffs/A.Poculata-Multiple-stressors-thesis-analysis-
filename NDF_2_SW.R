...
#
#       Date: 10/18/2021
#       Experiment name NDF_2_10.18.21_sw:
...
# data import
data <- read.csv("NDF_2_10.18.21_sw.xlsx - formated.csv", header=TRUE)
str(data)
...
#gather all rates 
MO2_list <-list (MO2_A2, MO2_A5, MO2_A6,
                 MO2_B2, MO2_B4, MO2_B5,  
                 MO2_C2, MO2_C3, MO2_C4, MO2_C5, 
                 MO2_D2)
...
# add sym state
MO2_df$Sym.state <- c(rep("sym", times = 6), rep("apo", times = 5))
...
#write.csv(MO2_df, file.path(path, "NDF_2_SW_allrate.csv"))
...
sym.list <- list(A2.data, A5.data, A6.data, 
...
apo.list <- list(C2.data, C3.data, C4.data, C5.data,  
                 D2.data)
