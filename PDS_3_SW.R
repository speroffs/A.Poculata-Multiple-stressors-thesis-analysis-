...
#
#       Date: 10/18/2021
#       Experiment name: PDS_3_10.18.21_sw
...
# data import
data <- read.csv("PDS_3_10.18.21_sw.xlsx - formated.csv", header=TRUE)
str(data)
...
#write.csv(MO2_df, file.path(path, "PDS_3_SW_allrate.csv"))
