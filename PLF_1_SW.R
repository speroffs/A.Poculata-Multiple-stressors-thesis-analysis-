...
#
#       Date: 10/10/2021
#       Experiment name: PLF_1_10.10.21_sw
...
# data import
data <- read.csv("PLF_1_10.10.21_sw.xlsx - formated.csv", header=TRUE)
str(data)
...
MO2_A2 <- convert_rate(A2_adjusted_rate,
                       ...
                       mass = 0.369,              # mass in GRAMS
                       t = 21.5,                 # temperature
                       S = 35,                   # salinity 
                       P = 1026.3/1013)               # atmospheric pressure
...
MO2_df$B.TAG <- (c("G44", "G46", "G48", "B48", "B50", 
                   "W43", "W45", "W47", "Y41", "Y43",
                   "G93", "G95", "G98", "W2", "W93",
                   "W95", "Y92"))
## Add "day"
