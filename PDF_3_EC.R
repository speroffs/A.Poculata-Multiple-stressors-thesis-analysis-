...
#
#       Date: 10/22/2021
#       Experiment name: PDF_3_10.22.21_e.col
...
# data import
data <- read.csv("PDF_3_10.22.21_e.coli.xlsx - formated.csv", header=TRUE)
str(data)
...
#subset to 4 hours (accidentally run to 5)
data <- data[1:961,]
...
MO2_A2 <- convert_rate(A2_adjusted_rate,
                       ...
                       mass = 0.261,              # mass in GRAMS
                       t = 20,                 # temperature
                       S = 35,                   # salinity 
                       P = 1009.3/1013)               # atmospheric pressure
...
MO2_df$B.TAG <- (c("B2", "B4", "B44", "B46", "W39",
                   "W41", "Y35", "Y37", "Y39",
                   "G87", "G92",       "B92", "B94",
                   "W84", "W87", "Y82", "Y84"))
## Add "day"
...
#write.csv(MO2_df, file.path(path, "PDF_3_EC_allrate.csv"))
...
apo.list <- list(C2.data, C3.data,          C5.data, C6.data, 
