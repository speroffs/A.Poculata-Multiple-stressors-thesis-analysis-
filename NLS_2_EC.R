...
#
#       Date: 10/14/2021
#       Experiment name: NLS_2_10.14.21_e.coli
...
# data import
data <- read.csv("NLS_2_10.14.21_e.coli.xlsx - formated.csv", header=TRUE)
str(data)
...
#write.csv(MO2_df, file.path(path, "NLS_2_EC_allrate.csv"))
