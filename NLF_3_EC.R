...
#
#       Date: 10/26/2021
#       Experiment name: NLF_3_10.26.21_e.coli
...
# data import
data <- read.csv("NLF_3_10.26.21_e.coli.xlsx - formated.csv", header=TRUE)
str(data)
...
neg <- data[,3:26] -(3.823528722) # mean calculated in google docs
...
MO2_df$B.TAG <- (c("G55", "B57", "B59", "B62", "W54", 
                   "W56", 
                   "B25", "W13", "Y8", "Y11", "O29"))
## Add "day"
MO2_df$Day <- "22"
...
#write.csv(MO2_df, file.path(path, "NLF_3_EC_allrate.csv"))
