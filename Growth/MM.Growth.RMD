...
###########################################################################################################################
#
#                                    Calculate growth rate for each individual polyp 
#
############################################################################################################################
...
growth.panel.figure.12<-
  annotate_figure(growth.panel.figure.12, 
                bottom = text_grob("Stress Treatment", 
                                   hjust = 0.35, vjust = -1, size = 18, face = "bold"),
                left = text_grob("Average growth rate (mg day"^"-1"~")", 
                                 rot = 90, vjust = 1.5, hjust = 0.4 , size = 18, face = "bold"))
growth.panel.figure.12
```
```{r}
ggsave(plot = growth.panel.figure.12,
       filename = "/Users/speroffs/Desktop/growth.panel.figure.12.jpg", 
       width = 8, height = 6, units = "in", dpi= 300)
```
