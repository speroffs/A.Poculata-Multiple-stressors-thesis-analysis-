...
#
#       Date: 10/12/2021
#       Experiment name: PLS_2_10.12.21_e.coli
...
# data import
data <- read.csv("PLS_2_10.12.21_e.coli.xlsx - formated.csv", header=TRUE)
str(data)
...
#write.csv(MO2_df, file.path(path, "PLS_2_EC_allrate.csv"))
