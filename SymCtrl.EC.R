...
#
#       Date: 10/7/2021
#       Experiment name: Sym_Control_10.27.21_e.coli
...
# data import
data <- read.csv("Sym_Control_10.27.21_e.coli.xlsx - formated.csv", header=TRUE)
str(data)
...
MO2_df$B.TAG <- (c("O36", "Y4156", "O41", "Y5281", "O46", 
                   "Y7364", "O50", "Y8794", "O54", "O56",
                   "Y615", "O63", "B1938", "B3941", "O71",
                   "B233", "B919", "O74", "B5431"))
## Add "day"
MO2_df$Day <- "22"
...
#write.csv(MO2_df, "Sym_Ctrl_3_EC_allrate.csv")
...
sym.list <- list(A2.data, A3.data, A4.data, A5.data, A6.data,
                 ...
                 D2.data, D3.data, D4.data, D6.data)
...
#write.csv(sym.dat, "Sym_Ctrl_EC_rate.csv")

#plot
ggplot(sym.dat, aes(Time.Elapsed.Min, value, col = vial)) +
  geom_point(alpha = 0.5) +
  geom_smooth(method="lm", se=FALSE) +
  ggtitle("Sym Control EC") +
