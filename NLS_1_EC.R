...
#
#       Date: 10/7/2021
#       Experiment name: NLS_1_10.7.21_e.coli
...
# data import
data <- read.csv("NLS_1_10.7.21_e.coli.xlsx - formated.csv", header=TRUE)
str(data)
...
#write.csv(MO2_df, file.path(path, "NLS_1_EC_allrate.csv"))
