...
#
#       Date: 10/14/2021
#       Experiment name: NLS_2_10.14.21_sw
...
# data import
data <- read.csv("NLS_2_10.14.21_sw.xlsx - formated.csv", header=TRUE)
str(data)
...
MO2_A2 <- convert_rate(A2_adjusted_rate,
                       ...
                       t = 20.2,                 # temperature
                       S = 35,                   # salinity 
                       P = 1021.6/1013)               # atmospheric pressure
...
#write.csv(MO2_df, file.path(path, "NLS_2_SW_allrate.csv"))
