...
#
#       Date: 10/7/2021
#       Experiment name: NLS_1_10.7.21_sw
...
# data import
data <- read.csv("NLS_1_10.7.21_sw.xlsx - formated.csv", header=TRUE)
str(data)
...
MO2_A2 <- convert_rate(A2_adjusted_rate,
                       ...
                       mass = 0.094,              # mass in GRAMS
                       t = 21.9,                 # temperature
                       S = 35,                   # salinity 
                       P = 1025.4/1013)               # atmospheric pressure
...
MO2_list <-list (MO2_A2, MO2_A3, MO2_A4, MO2_A5, MO2_A6,
                 ...
                 MO2_C2, MO2_C4, MO2_C5, MO2_C6, 
                 MO2_D2, MO2_D4, MO2_D5, MO2_D6)
...
MO2_df$B.TAG <- (c("G39", "G41", "G43", "B38", "B40", 
                   "W33", "W35", "W37", "Y31", "Y33",
                   "G79", "G84", "B83", "B85",
                   "W77", "W82", "Y75", "Y77"))
## Add "day"
...
#write.csv(MO2_df, file.path(path, "NLS_1_SW_allrate.csv"))
...
apo.list <- list(C2.data, C4.data, C5.data, C6.data, 
                 D2.data, D4.data, D5.data, D6.data)
