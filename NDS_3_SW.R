...
#
#       Date: 10/20/2021
#       Experiment name: NDS_3_10.20.21_sw
...
# data import
data <- read.csv("NDS_3_10.20.21_no.ecoli.xlsx - formated.csv", header=TRUE)
str(data)
...
MO2_df$B.TAG <- (c("G33", "G35", "G38", "B33", "B35",   # ROW A VIALS
                   ...
                   "G76", "G78", "B77", "B79", "W72",   # ROW C VIALS
                   "W74", "W76", "Y70", "Y72"))         # ROW D VIALS
# Add "day"
MO2_df$Day <- "22"
...
#write.csv(MO2_df, file.path(path, "NDS_3_SW_allrate.csv"))
