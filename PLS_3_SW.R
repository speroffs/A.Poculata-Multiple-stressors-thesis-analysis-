...
#
#       Date: 10/19/2021
#       Experiment name: PLS_3_10.19.21_sw
...
# data import
data <- read.csv("PLS_3_10.19.21_sw.xlsx - formated.csv", header=TRUE)
str(data)
...
MO2_A2 <- convert_rate(A2_adjusted_rate,
                       ...
                       t = 20.3,                 # temperature
                       S = 35,                   # salinity 
                       P = 1007.8/1013)               # atmospheric pressure
...
# add sym state
MO2_df$Sym.state <- c(rep("sym", times = 8), rep("apo", times = 8))
...
#write.csv(MO2_df, file.path(path, "PLS_3_SW_allrate.csv"))
