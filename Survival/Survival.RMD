...
Km.surv.fig <- ggsurvplot(treat, # survival function
                ...
                legend.labs = c("Control", "PDS", "PLS", "NDS", "NLS", "PDF", "PLF", "NDF", "NLF"), # treatments
                legend = c(0.1, 0.35), font.legend = 11, legend.title ="", # legend parameters 
                xlab = "Day", xlim = c(0, 23), break.x.by = 2, font.x = 12, # x axis parameters
                ylim = c(0.65,1), font.y= 12, # y axis parameters
                censor.size = 6,
                ggtheme = theme_classic2(),
                title = "A.",
                palette = c("#131513","#F53100", "#FF8B47","#C39809","#F6CB3C","#0B8454", "#7BB12F","#3F88C5","#A33461"))
Km.surv.fig 
```
...
km.plastic.fig <- 
  ggsurvplot(plastic, 
          conf.int = FALSE, pval = FALSE, surv.scale = "default", # or %
           legend.labs = c("No plastic", "Plastic"), legend.title = "", legend = c(0.15, 0.2), font.legend = 12,
