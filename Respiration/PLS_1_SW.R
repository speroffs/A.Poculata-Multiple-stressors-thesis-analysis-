...
#
#       Date: 10/5/2021
#       Experiment name PLS_1_10.5.21_sw:
...
# data import
data <- read.csv("PLS_1_10.5.21_sw.xlsx - formated.csv", header=TRUE)
str(data)
...
MO2_A2 <- convert_rate(A2_adjusted_rate,
                       ...
                       mass = 0.286,              # mass in GRAMS
                       t = 21,                 # temperature
                       S = 35,                   # salinity 
                       P = 1021/1013)               # atmospheric pressure
...
#write.csv(MO2_df, file.path(path, "PLS_1_SW_allrate.csv"))
