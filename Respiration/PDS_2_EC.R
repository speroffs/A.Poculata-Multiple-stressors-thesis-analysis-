...
#
#       Date: 10/11/2021
#       Experiment name: PDS_2_10.11.2021_e.coli
...
# data import
data <- read.csv("PDS_2_10.11.2021_e.coli.xlsx - formated.csv", header=TRUE)
str(data)
...
MO2_A2 <- convert_rate(A2_adjusted_rate,
                       ...
                       t = 18.6,                 # temperature
                       S = 35,                   # salinity 
                       P = 1021.5/1013)               # atmospheric pressure
...
MO2_df$B.TAG <- (c("G24", "G26", "B13", "B15", "W21", 
                          "Y17", 
                   "G60", "G64", "B63", "B65", "B70",
                   "W59", "W62", "Y59"))
## Add "day"
...
# add sym state
MO2_df$Sym.state <- c(rep("sym", times = 6), rep("apo", times = 8))
...
#write.csv(MO2_df, file.path(path, "PDS_2_EC_allrate.csv"))
