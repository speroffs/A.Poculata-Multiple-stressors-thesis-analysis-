...
#
#       Date: 10/6/2021
#       Experiment name NDS_1_10.6.21_no.ecoli:
...
# data import
data <- read.csv("NDS_1_10.6.21_no.ecoli.xlsx - formated.csv", header=TRUE)
...
MO2_A2 <- convert_rate(A2_adjusted_rate,
                       ...
                       mass = 0.453,              # mass in GRAMS
                       t = 20.1,                 # temperature
                       S = 35,                   # salinity 
                       P = (1028.7/1013))       # atmospheric pressure in atm (mbar/1013)
...
MO2_df$B.TAG <- (c("G33", "G35", "G38", "B33", "B35",   # ROW A VIALS
                   "W28", "W30", "W32", "Y26", "Y28",   # ROW B VIALS
                          "G76", "G78", "B77", "B79",   # ROW C VIALS
                   "W72", "W74", "W76", "Y70", "Y72"))  # ROW D VIALS
# Add "day"
MO2_df$Day <- "8"
...
#write.csv(MO2_df, file.path(path, "NDS_1_SW_allrate.csv"))
...
apo.list <- list(         C3.data, C4.data, C5.data, C6.data, 
