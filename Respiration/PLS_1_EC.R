...
#
#       Date: 10/5/2021
#       Experiment name: PLS_1_10.5.21_e.coli
...
# data import
data <- read.csv("PLS_1_10.5.21_e.coli..xlsx - formated.csv", header=TRUE)
str(data)
...
#write.csv(MO2_df, file.path(path, "PLS_1_EC_allrate.csv"))
