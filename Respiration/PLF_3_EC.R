...
#
#       Date: 10/24/2021
#       Experiment name: PLF_3_10.24.21_e.coli
...
# data import
data <- read.csv("PLF_3_10.24.21_e.coli.xlsx - formated.csv", header=TRUE)
str(data)
...
MO2_df$B.TAG <- (c("G45", "G47", "B47", "B49", "W44", 
                   "W46", "Y42", "Y44",
                   "G97", "W92", "W94", "Y88", "Y93"))
## Add "day"
MO2_df$Day <- "22"
...
# add sym state
MO2_df$Sym.state <- c(rep("sym", times = 8), rep("apo", times = 5))
...
#write.csv(MO2_df, file.path(path, "PLF_3_EC_allrate.csv"))
