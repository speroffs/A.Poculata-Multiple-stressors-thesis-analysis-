...
#
#       Date: 10/18/2021
#       Experiment name: PDS_3_10.18.21_e.coli
...
# data import
data <- read.csv("PDS_3_10.18.21_e.coli.xlsx - formated.csv", header=TRUE)
str(data)
...
MO2_A2 <- convert_rate(A2_adjusted_rate,
                       ...
                       t = 20.6,                 # temperature
                       S = 35,                   # salinity 
                       P = 1005.7/1013)               # atmospheric pressure
...
#write.csv(MO2_df, file.path(path, "PDS_3_EC_allrate.csv"))
