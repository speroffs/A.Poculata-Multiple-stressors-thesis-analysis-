...
#
#       Date: 10/11/2021
#       Experiment name NDF_1_10.11.21_no.ecoli:
...
# data import
data <- read.csv("NDF_1_10.11.21_no.ecoli.xlsx - formated.csv", header=TRUE)
str(data)
...
MO2_A2 <- convert_rate(A2_adjusted_rate,
                       ...
                       t = 19.6,                 # temperature
                       S = 35,                   # salinity 
                       P = 1019.8/1013)               # atmospheric pressure
...
MO2_df$B.TAG <- (c("G49", "G51", "G53", "B53", "B55", # ROW A VIALS
                   "W48", "W50", "W52", "Y46", "Y48",
                   "B7", "B10", "B12", "O7681", "O9174",
                   "W98", "Y2", "Y4", "Y97"))
## Add "day"
MO2_df$Day <- "8"
...
write.csv(MO2_df, file.path(path, "NDF_1_SW_allrate.csv"))
