...
#
#       Date: 10/17/2021
#       Experiment name: PLF_2_10.17.21_sw
...
# data import
data <- read.csv("PLF_2_10.17.21_sw.xlsx - formated.csv", header=TRUE)
str(data)
...
#write.csv(MO2_df, file.path(path, "PLF_2_SW_allrate.csv"))
