...
#
#       Date: 10/21/2021
#       Experiment name: NLS_3_10.21.21_sw
...
# data import
data <- read.csv("NLS_3_10.21.21_sw.xlsx - formated.csv", header=TRUE)
str(data)
...
#write.csv(MO2_df, file.path(path, "NLS_3_SW_allrate.csv"))
