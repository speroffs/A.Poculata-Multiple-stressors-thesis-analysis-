...
#
#       Date: 10/26/2021
#       Experiment name: NLF_3_10.26.21_sw
...
# data import
data <- read.csv("NLF_3_10.26.21_sw.xlsx - formated.csv", header=TRUE)
str(data)
...
MO2_A2 <- convert_rate(A2_adjusted_rate,
                       ...
                       t = 21.4,                 # temperature
                       S = 35,                   # salinity 
                       P = 1003.6/1013)               # atmospheric pressure
...
# add sym state
MO2_df$Sym.state <- c(rep("sym", times = 10), rep("apo", times = 5))
...
#write.csv(MO2_df, file.path(path, "NLF_3_SW_allrate.csv"))
