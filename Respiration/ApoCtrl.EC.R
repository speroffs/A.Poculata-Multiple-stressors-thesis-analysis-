...
#
#       Date: 10/28/2021
#       Experiment name: Apo_Control_10.28.21_e.coli
...
# data import
data <- read.csv("Apo_Control_10.28.21_e.coli.xlsx - formated.csv", header=TRUE)
str(data)
...
MO2_df$B.TAG <- (c("O79", "B6947", "O83", "G9116", "O94", 
                   "G1991", "O97", "G7673", "Y156", "G8180",
                   "G9877", "Y2820", "O986", "O9659", "Y2223",
                   "O646", "O6719", "Y4350", "W3", "W8"))
## Add "day"
MO2_df$Day <- "22"
...
# export
#write.csv(MO2_df, "Apo_Ctrl_3_EC_allrate.csv")
...
#write.csv(apo.dat, "Apo_Ctrl_EC_rate.csv")

#plot
ggplot(apo.dat, aes(Time.Elapsed.Min, value, col = vial)) +
  geom_point(alpha = 0.5) +
  geom_smooth(method="lm", se=FALSE) +
  ggtitle("Apo Control EC") +
