...
#
#       Date: 10/13/2021
#       Experiment name NDS_2_10.13.21_e.coli:
...
# data import
data <- read.csv("NDS_2_10.13.21_e.coli.xlsx - formated.csv", header=TRUE)
str(data)
...
MO2_A2 <- convert_rate(A2_adjusted_rate,
                       ...
                       mass = 0.206,              # mass in GRAMS
                       t = 19.2,                 # temperature
                       S = 35,                   # salinity 
                       P = 1016.5/1013)               # atmospheric pressure
...
#write.csv(MO2_df, file.path(path, "NDS_2_EC_allrate.csv"))
