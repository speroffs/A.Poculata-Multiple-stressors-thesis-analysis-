...
#
#       Date: 10/24/2021
#       Experiment name: PLF_3_10.24.21_sw
...
# data import
data <- read.csv("PLF_3_10.24.21_sw.xlsx - formated.csv", header=TRUE)
str(data)
...
MO2_A2 <- convert_rate(A2_adjusted_rate,
                       ...
                       mass = 0.355,              # mass in GRAMS
                       t = 19.2,                 # temperature
                       S = 35,                   # salinity 
                       P = 1021.1/1013)               # atmospheric pressure
...
MO2_df$B.TAG <- (c("G44", "G46", "G48", "B50", "W43", 
                   "W45", "Y41", "Y43",
                   "G93", "G95", "G98", "W2", "W93",
                   "W95", "Y92"))
## Add "day"
...
# add sym state
MO2_df$Sym.state <- c(rep("sym", times = 8), rep("apo", times = 7))
...
#write.csv(MO2_df, file.path(path, "PLF_3_SW_allrate.csv"))
