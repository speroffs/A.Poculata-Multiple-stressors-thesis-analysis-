...
#
#       Date: 10/12/2021
#       Experiment name: PLS_2_10.12.21_sw
...
# data import
data <- read.csv("PLS_2_10.12.21_sw.xlsx - formated.csv", header=TRUE)
str(data)
...
#neg <- data[,3:26] - mean(data[,6]) # NOT WORKING?
neg <- data[,3:26] - 22.10081 # calculated from raw data in google sheets
...
MO2_list <-list (MO2_A2, MO2_A3, MO2_A4, MO2_A5, MO2_A6,
                 ...
                 MO2_C2, MO2_C3, MO2_C4,         MO2_C6, 
                 MO2_D2, MO2_D3, MO2_D4, MO2_D5)
...
MO2_df$B.TAG <- (c("G28", "G30", "G32", "B28", "B31", 
                   "W24", "W26", "Y22", "Y24",
                   "G65", "G70", "G73", "B74",
                   "W64", "W67", "W71", "Y64"))
## Add "day"
...
apo.list <- list(C2.data, C3.data, C4.data, C6.data, 
                 D2.data, D3.data, D4.data, D5.data)
