...
#
#       Date: 10/12/2021
#       Experiment name: NLF_1_10.12.21_e.coli
...
# data import
data <- read.csv("NLF_1_10.12.21_e.coli.xlsx - formated.csv", header=TRUE)
str(data)
...
MO2_df$B.TAG <- (c("G55", "G57", "B57", "B59", "B62", 
                   "W54", "W56", "Y50", "Y52", "Y54",
                   "B23", "B25", "W10", "W13", "Y8",
                   "Y11", "O29", "O31"))
## Add "day"
...
# add sym state
MO2_df$Sym.state <- c(rep("sym", times = 10), rep("apo", times = 8))
...
#write.csv(MO2_df, file.path(path, "NLF_1_EC_allrate.csv"))
