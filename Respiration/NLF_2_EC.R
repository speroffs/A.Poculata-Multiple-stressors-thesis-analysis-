...
#
#       Date: 10/19/2021
#       Experiment name: NLF_2_10.19.21_e.coli
...
# data import
data <- read.csv("NLF_2_10.19.21_e.coli.xlsx - formated.csv", header=TRUE)
str(data)
...
write.csv(MO2_df, file.path(path, "NLF_2_EC_allrate.csv"))
