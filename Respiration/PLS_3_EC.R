...
#
#       Date: 10/19/2021
#       Experiment name: PLS_3_10.19.21_e.coli
...
# data import
data <- read.csv("PLS_3_10.19.21_e.coli.xlsx - formated.csv", header=TRUE)
str(data)
...
MO2_df$B.TAG <- (c("G29", "G31", "B27", "B30", "W23", 
                   "W25", "W27", "Y23",
                   "G67", "G71", "B73", "B75", "W65", 
                   "Y60", "Y65"))
## Add "day"
...
#write.csv(MO2_df, file.path(path, "PLS_3_EC_allrate.csv"))
