...
#
#       Date: 10/15/2021
#       Experiment name: PDF_2_10.15.21_e.coli
...
# data import
data <- read.csv("PDF_2_10.15.21_e.coli.xlsx - formated.csv", header=TRUE)
str(data)
...
#write.csv(MO2_df, file.path(path, "PDF_2_EC_allrate.csv"))
