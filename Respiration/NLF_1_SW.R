...
#
#       Date: 10/12/2021
#       Experiment name: NLF_1_10.12.21_sw
...
# data import
data <- read.csv("NLF_1_10.12.21_sw.xlsx - formated.csv", header=TRUE)
str(data)
...
MO2_A2 <- convert_rate(A2_adjusted_rate,
                       ...
                       t = 20.5,                 # temperature
                       S = 35,                   # salinity 
                       P = 1020.1/1013)               # atmospheric pressure
...
MO2_df$B.TAG <- (c("G54", "G56", "G58", "B58", "B60",
                   "W53", "W55", "W57", "Y51", "Y53",
                   "B22", "B24", "B26", "W11", "W14",
                   "Y5", "Y10", "O27","O30"))
## Add "day"
