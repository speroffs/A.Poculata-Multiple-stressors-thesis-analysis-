...
#
#       Date: 10/6/2021
#       Experiment name NDS_1_10_6_e.coli:
...
# data import
data <- read.csv("NDS_1_10_6_e.coli.xlsx - formated.csv", header=TRUE)
str(data)
...
# Calc background rate of sw  data 
...
# Calc background rate of neg o2  data 
...
MO2_A2 <- convert_rate(A2_adjusted_rate,
                       ...
                       mass = 0.053,              # mass in GRAMS
                       t = 20.1,                 # temperature
                       S = 35,                   # salinity 
                       P = (1028.7/1013))               # atmospheric pressure
...
#                       mass = 0.13,              # mass in GRAMS
#                       t = 19.6,                 # temperature
#                       S = 35,                   # salinity 
#                       P = 1.019)               # atmospheric pressure
...
#gather all rates 
MO2_list <-list (MO2_A2, MO2_A3,         MO2_A5, MO2_A6,
...
MO2_df$vial <- (c("A2", "A3",       "A5", "A6",
                  "B2", "B3", "B4", "B5", "B6",
                  "C2", "C3", "C4",       "C6",
                  "D2", "D3", "D4", "D5", "D6"))

# Add B.TAG for individuals in those respective vials
MO2_df$B.TAG <- (c("G34", "G37", "B34", "B36", 
                   "W29", "W31", "Y25", "Y27", "Y29",
                   "G75", "G77", "B76", "B80",
                   "W73", "W75", "Y67", "Y71", "Y73"))
...
# add sym state
MO2_df$Sym.state <- c(rep("sym", times = 9), rep("apo", times = 9))
...
#write.csv(MO2_df, file.path(path, "NDS_1_EC_allrate.csv"))
...
sym.list <- list(A2.data, A3.data, A5.data, A6.data, 
