...
#
#       Date: 10/4/2021
#       Experiment name PDS_1_10.4.21_sw:
...
# data import
data <- read.csv("PDS_1_10.4.21_e.coli.xlsx - formated.csv", header=TRUE)
str(data)
...
MO2_A2 <- convert_rate(A2_adjusted_rate,
                       ...
                       t = 20.3,                 # temperature
                       S = 35,                   # salinity 
                       P = 1016/1013)               # atmospheric pressure
...
MO2_df$B.TAG <- (c("G24", "B13", "B21", "W21", "Y14", 
                   "G26", "B15", "W17", "Y12", "Y17",
                   "G60", "B63", "B70", "W62", "Y55",
                   "G64", "B65", "W59", "Y57", "Y59"))
## Add "day"
...
# add sym state
MO2_df$Sym.state <- c(rep("sym", times = 10), rep("apo", times = 10))
...
#write.csv(MO2_df, file.path(path, "PDS_1_EC_allrate.csv"))
