...
#
#       Date: 10/15/2021
#       Experiment name: PDF_2_10.15.21_sw
...
# data import
data <- read.csv("PDF_2_10.15.21_sw.xlsx - formated.csv", header=TRUE)
str(data)
...
MO2_A2 <- convert_rate(A2_adjusted_rate,
                       ...
                       mass = 0.252,              # mass in GRAMS
                       t = 20.5,                 # temperature
                       S = 35,                   # salinity 
                       P = 1014.4/1013)               # atmospheric pressure
...
MO2_df$B.TAG <- (c("B1", "B3", "B5", "B43", "W38", 
                   "W40", "W42", "Y36", "Y38",
                   "G85", "G88", "G90", "B93", "W83",
                   "W85", "Y79", "Y83"))
## Add "day"
