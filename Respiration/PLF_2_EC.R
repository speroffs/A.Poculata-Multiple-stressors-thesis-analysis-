...
#
#       Date: 10/17/2021
#       Experiment name: PLF_2_10.17.21_e.coli
...
# data import
data <- read.csv("PLF_2_10.17.21_e.coli.xlsx - formated.csv", header=TRUE)
str(data)
...
MO2_A2 <- convert_rate(A2_adjusted_rate,
                       ...
                       t = 19.7,                 # temperature
                       S = 35,                   # salinity 
                       P = 1005.3/1013)               # atmospheric pressure
...
MO2_df$B.TAG <- (c("G45", "G47", "B47", "B49", "B51",
                   "W44", "W46", "Y42", "Y44",
                   "G97", "B97", "W92", "W94", "Y88", 
                   "Y93"))
## Add "day"
...
# add sym state
MO2_df$Sym.state <- c(rep("sym", times = 9), rep("apo", times = 6))
...
#write.csv(MO2_df, file.path(path, "PLF_2_EC_allrate.csv"))
...
sym.list <- list(A2.data, A3.data, A4.data, A5.data, A6.data, 
                 B2.data, B3.data, B5.data, B6.data)
