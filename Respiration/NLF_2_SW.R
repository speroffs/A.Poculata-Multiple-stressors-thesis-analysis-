...
#
#       Date: 10/19/2021
#       Experiment name: NLF_2_10.19.21_sw
...
# data import
data <- read.csv("NLF_2_10.19.21_sw.xlsx - formated.csv", header=TRUE)
str(data)
...
MO2_A2 <- convert_rate(A2_adjusted_rate,
                       ...
                       t = 19.6,                 # temperature
                       S = 35,                   # salinity 
                       P = 1010.9/1013)               # atmospheric pressure
...
#write.csv(MO2_df, file.path(path, "NLF_2_SW_allrate.csv"))
