...
#
#       Date: 10/13/2021
#       Experiment name: NDS_2_10.13.21_no.ecoli
...
# data import
data <- read.csv("NDS_2_10.13.21_no.ecoli.xlsx - formated.csv", header=TRUE)
str(data)
...
#write.csv(MO2_df, file.path(path, "NDS_2_SW_allrate.csv"))
