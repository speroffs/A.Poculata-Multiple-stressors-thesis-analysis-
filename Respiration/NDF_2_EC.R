...
# data import
data <- read.csv("NDF_2_10.18.21_e.coli.xlsx - formated.csv", header=TRUE)
str(data)
...
MO2_df$B.TAG <- (c("G50", "G52", "B52", "B56", "W49",
                   "W51", "Y47", "Y49",
                   "B11", "O7096", "O7398", "Y1", "Y3"))
...
#write.csv(MO2_df, file.path(path, "NDF_2_EC_allrate.csv"))
