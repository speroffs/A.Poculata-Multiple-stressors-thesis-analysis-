...
#
#       Date: 10/10/2021
#       Experiment name: PLF_1_10.10.21_e.coli
...
# data import
data <- read.csv("PLF_1_10.10.21_e.coli.xlsx - formated.csv", header=TRUE)
str(data)
...
# add sym state
MO2_df$Sym.state <- c(rep("sym", times = 10), rep("apo", times = 6))
...
#write.csv(MO2_df, file.path(path, "PLF_1_EC_allrate.csv"))
