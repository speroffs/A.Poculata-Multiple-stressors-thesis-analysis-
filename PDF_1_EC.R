...
#
#       Date: 10/8/2021
#       Experiment name: PDF_1_10.8.21_e.coli
...
# data import
data <- read.csv("PDF_1_10.8.21_e.coli.xlsx - formated.csv", header=TRUE)
str(data)
...
MO2_df$B.TAG <- (c("B2", "B4", "B42", "B44", "B46", 
                   "W39", "W41", "Y35", "Y37", "Y39",
                   "G87", "G92", "B88", "B92", "B94",
                   "W84", "W87", "Y82", "Y84"))
## Add "day"
...
#write.csv(MO2_df, file.path(path, "PDF_1_EC_allrate.csv"))
