...
#
#       Date: 10/11/2021
#       Experiment name PDS_2_10.11.2021_sw:
...
# data import
data <- read.csv("PDS_2_10.11.2021_sw.xlsx - formated.csv", header=TRUE)
str(data)
...
MO2_df$B.TAG <- (c("G4", "G25", "G27", "B14", "B20", 
                   "W15", "W20", "W22", "Y15",
                   "G59", "G63", "B64", "B67", "W58",
                   "W60", "W63", "Y56", "Y58"))
## Add "day"
...
#write.csv(MO2_df, file.path(path, "PDS_2_SW_allrate.csv"))
