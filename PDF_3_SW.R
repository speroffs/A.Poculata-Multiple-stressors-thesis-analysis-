...
#
#       Date: 10/22/2021
#       Experiment name: PDF_3_10.22.21_sw
...
# data import
data <- read.csv("PDF_3_10.22.21_sw.xlsx - formated.csv", header=TRUE)
str(data)
...
# cut to 4 hours (accidentally run to 5)
data <- data[1:961,]
###########################################################
#
#                Saltwater Controls 
...
# add sym state
MO2_df$Sym.state <- c(rep("sym", times = 9), rep("apo", times = 7))
...
#write.csv(MO2_df, file.path(path, "PDF_3_SW_allrate.csv"))
