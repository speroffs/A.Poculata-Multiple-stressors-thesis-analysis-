...
# data import
data <- read.csv("PDS_1_10.4.21_sw.xlsx - formated.csv", header=TRUE)
str(data)
...
MO2_df$B.TAG <- (c("G4", "G27", "B20", "W20", "Y13", 
                   "G25", "B14", "W15", "W22", "Y15",
                   "G59", "B64", "W58", "W63", "Y56",
                   "G63", "B67", "W60", "Y58"))
## Add "day"
...
#write.csv(MO2_df, file.path(path, "PDS_1_SW_allrate.csv"))
