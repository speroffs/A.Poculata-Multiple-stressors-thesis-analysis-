...
#
#       Date: 10/8/2021
#       Experiment name: PDF_1_10.8.21_sw
...
# data import
data <- read.csv("PDF_1_10.8.21_sw.xlsx - formated.csv", header=TRUE)
str(data)
...
MO2_A2 <- convert_rate(A2_adjusted_rate,
                       ...
                       mass = 0.248,              # mass in GRAMS
                       t = 20.4,                 # temperature
                       S = 35,                   # salinity 
                       P = 1021.9/1013)               # atmospheric pressure
...
#gather all rates 
MO2_list <-list (MO2_A2, MO2_A3, MO2_A4, MO2_A5,
...
MO2_df$vial <- (c("A2", "A3", "A4", "A5",
                  "B2", "B3", "B4", "B5", "B6",
                  "C2", "C3", "C4", "C5", "C6",
                  "D2", "D3", "D4"))

# Add B.TAG for individuals in those respective vials
MO2_df$B.TAG <- (c("B1", "B3", "B5", "B43", 
                   "W38", "W40", "W42", "Y36", "Y38",
                   "G85", "G88", "G90", "B93", "W83",
                   "W85", "Y79", "Y83"))
## Add "day"
...
#write.csv(MO2_df, file.path(path, "PDF_1_SW_allrate.csv"))
...
sym.list <- list(A2.data, A3.data, A4.data, A5.data, 
