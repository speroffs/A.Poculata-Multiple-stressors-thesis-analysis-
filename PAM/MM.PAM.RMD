...
setwd("/Users/speroffs/Desktop/thesis_backup/PAM") # Oats

# load the data 
#data <- read.csv("Full_Fv_Fm.data - FvFm.long.format.csv", header = TRUE)
data <- read.csv("Full_Fv_Fm.data - Edited.FvFm.csv", header = TRUE) #edited dataframe without day 22 for NDF/NLF
```
```{r}
...
#  sink(paste("/Users/speroffs/Desktop/A.Poculata-Multiple-stressors-thesis-analysis-/PAM/PAM.model.outputs/", 
...
# sink(paste("/Users/speroffs/Desktop/A.Poculata-Multiple-stressors-thesis-analysis-/PAM/PAM.model.outputs/",
  ...
  exp.treat.lmer2.aov <- anova(null, Q1, exp.treat.lmer2) # model comparison
...
ggplot(phen.means, 
  ...
  geom_errorbar(aes(ymin=fvfm-se, ymax=fvfm+se), width=0.2, size = 1, position = position_dodge(0.2)) +
...
# sink(paste("/Users/speroffs/Desktop/A.Poculata-Multiple-stressors-thesis-analysis-/PAM/PAM.model.outputs/",
  ...
  exp.treat.lmer3.aov <- anova(null, Q1, Q2, exp.treat.lmer3) # model comparison to the null 
...
sink(
  paste("/Users/speroffs/Desktop/A.Poculata-Multiple-stressors-thesis-analysis-/PAM/PAM.model.outputs/", # path
...
PN.fvfm.plot<-
  ...
  scale_y_continuous(limits = c(0.15, 0.3), breaks = seq(0.15, 0.3, by = 0.05)) +
...
ggsave(plot = PN.fvfm.plot,
       filename = "/Users/speroffs/Desktop/A.Poculata-Multiple-stressors-thesis-analysis-/PAM/Plots/PN.fvfm.plot.pdf", 
       width = 8, height = 6, units = "in")
...
ggsave(plot = LD.fvfm.plot,
       filename = "/Users/speroffs/Desktop/A.Poculata-Multiple-stressors-thesis-analysis-/PAM/Plots/LD.fvfm.plot.pdf", 
       width = 8, height = 6, units = "in")
...
ggsave(plot = FS.fvfm.plot,
       filename = "/Users/speroffs/Desktop/A.Poculata-Multiple-stressors-thesis-analysis-/PAM/Plots/FS.fvfm.plot.pdf", 
       width = 8, height = 6, units = "in")
...
sink(paste("/Users/speroffs/Desktop/A.Poculata-Multiple-stressors-thesis-analysis-/PAM/PAM.model.outputs/", # path
...
ggplot(data = plastic.sum2,
  ...
  geom_point(size=1.2) +
  geom_line(aes(group=Plastic), size = 1.2, linetype = rep(seq(1,2,1), each=4)) +
  geom_errorbar(aes(ymin=fvfm-se, ymax=fvfm+se), width=0.1, size = 1.2) +
  
  scale_linetype_manual(labels = c("No plastic", "Plastic"), values = c(1,2)) +
  scale_color_manual(labels = c("No plastic", "Plastic"), values = c("black","black")) +
...
ggplot(data = light.sum2,
       aes(x = Day,
           ...
           group = Light)) +
  geom_point(size=1.2) +
  geom_line(aes(group=Light), size = 1.2, linetype = rep(seq(2,1,-1), each=4)) +
  geom_errorbar(aes(ymin=fvfm-se, ymax=fvfm+se), width=0.1, size = 1.2) +
  
  scale_linetype_manual(labels = c("Dark", "Light"), values = c(1,2)) +
  scale_color_manual(labels = c("Dark", "Light"), values = c("black","black")) +
...
ggplot(data = food.sum2,
       aes(x = Day,
           ...
           group = Food)) +
  geom_point(size=1.2) +
  geom_line(aes(group=Food), size = 1.2, linetype = rep(seq(1, 2, 1), each=4)) +
  geom_errorbar(aes(ymin=fvfm-se, ymax=fvfm+se), width=0.1, size = 1.2) +
  
  scale_linetype_manual(labels = c("Fed", "Starved"), values = c(1,2)) +
  scale_color_manual(labels = c("Fed", "Starved"), values = c("black","black")) +
...
ggplot(data = temp.sum2,
  ...
  scale_color_manual(labels = "Elevated (30C)", values = "black") +
  scale_x_continuous(name = "", breaks=seq(1, 22, by = 7)) +
  scale_y_continuous(name = "", limits = c(0.13, 0.3), breaks=seq(0.13, 0.3, by = 0.05)) +
