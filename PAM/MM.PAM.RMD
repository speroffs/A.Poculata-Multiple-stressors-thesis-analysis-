...
PN.fvfm.plot<-
  ...
  annotate("text", x = 1, y = 0.3, label = deparse("C. Plastic"), parse = TRUE, size = 14) +
...
ggplot(data = light.sum1,
  ...
  annotate("text", x = 1, y = 0.3, label = deparse("E. Light"), parse = TRUE, size = 14) +
...
ggplot(data = food.sum1,
  ...
  scale_y_continuous(limits = c(0.15, 0.31), breaks = seq(0.15, 0.3, by = 0.05)) +
    ...
    annotate("text", x = 1, y = 0.3, label = deparse("F. Food"), parse = TRUE, size = 14) +
...
ggplot(data = temp.sum1,
  ...
  annotate("text", x = 1.2, y = 0.305, label = deparse("A. Temperature"), parse = TRUE, size = 14) +
...
fvfm.panel1 <- ggarrange(AE.fvfm.plot, PN.fvfm.plot, LD.fvfm.plot, FS.fvfm.plot, 
